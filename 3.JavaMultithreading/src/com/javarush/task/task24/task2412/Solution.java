...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        list.sort((stock1, stock2) -> {
            ...
            if (result == 0)
                if (((double) stock2.get("change"))>((double) stock1.get("change")))
                    result = 1;
                else result = -1;
            return result;
        });
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Oracle Corporation", "ORCL", .15, new GregorianCalendar(2015, 6, 2).getTime()));
        stocks.add(new Stock("Fake Oracle Corporation", "ORCL", -0.15, new GregorianCalendar(2015, 6, 2).getTime()));
        stocks.add(new Stock("Fake Oracle Corporation", "ORCL", .15, getRandomDate()));
